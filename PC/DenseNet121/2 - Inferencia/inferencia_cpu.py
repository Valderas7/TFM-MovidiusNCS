...
filas = open('/home/user/T-F-M/densenet121/modelos/labels.txt').read().strip().split("\n") # Divide en filas el documento
...
directorio = "/home/user/T-F-M/densenet121/test"
imagenes = []

# Se carga la red preentrenada:
red = cv2.dnn.readNetFromCaffe('/home/user/T-F-M/densenet121/modelos/densenet-121.prototxt', '/home/user/T-F-M/densenet121/modelos/densenet-121.caffemodel')
