...
red = cv2.dnn.readNetFromCaffe('/home/user/T-F-M/vgg16/modelos/vgg16.prototxt', '/home/user/T-F-M/vgg16/modelos/vgg16.caffemodel')
...
# Se realiza "mean subtraction" (103.939,116.779,123.68) para normalizar las imágenes de entrada
...
for j in range(len(imagenes)):
    ...
    blob = cv2.dnn.blobFromImage(imagenes[j], 1, (224, 224), (103.939,116.779,123.68))
    red.setInput(blob)
