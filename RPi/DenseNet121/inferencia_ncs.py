...
filas = open('/home/pi/T-F-M/densenet121/modelos/labels.txt').read().strip().split("\n") # Divide en filas el documento
...
directorio = "/home/pi/T-F-M/densenet121/test"
imagenes = []

# Se carga la red preentrenada:
red = cv2.dnn.readNet('/home/pi/T-F-M/densenet121/modelos/densenet-121.bin', '/home/pi/T-F-M/densenet121/modelos/densenet-121.xml')
